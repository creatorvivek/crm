...
<form id="form_validation" method="POST"  action="<?= base_url() ?>purchase/add_purchase_process">
    ...
    <div class="card">
      ...
      <div class="body">
            ...
            <select class="form-control show-tick"   id="item1" aria-required="true" onchange="item_fetch(1)">
              ...
              <?php {
                foreach($item as $row)
                {
                  ...
                  <option value="<?= $row['id'] ?>"  data-toggle="tooltip" title="<?= $row['description'].',company name :- '.$row['company_name'] ?>" data-html="true" ><?= $row['item_name'] ?></option>
                <?php   }
        ...
        <div class="col-md-4">
         <div class="form-group form-float">
          <div class="form-line">
            <input type="text" class="form-control datemask" required  readonly='true' id="date"  name="purchase_date"   placeholder="purchase date">
...
<div class="card mod6" style="overflow-y: scroll;max-height: 700px;display:none;">
<div class="newRow6"></div>
</div>
<div class="card mod7" style="overflow-y: scroll;max-height: 700px;display:none;">
